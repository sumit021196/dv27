  ...
  return (
    <main className="min-h-screen bg-black pt-32 pb-20 px-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-6xl md:text-8xl font-black uppercase tracking-tighter text-white mb-12">Exchange & Returns</h1>
        <div className="prose prose-invert max-w-none text-white/60 uppercase tracking-widest text-sm leading-loose">
          ...
          <p>Please contact support@thedv27.com to initiate an exchange.</p>
        </div>
      </div>
    </main>
  );
