...
export default function HeroSection({ banners = [] }: { banners?: any[] }) {
    ...
    if (!mounted) {
        return (
            <section className="h-[40vh] sm:h-[50vh] lg:h-[calc(100vh-7rem)] w-full bg-background flex items-center justify-center">
    ...
    if (activeBanners.length === 0) {
        ...
        return (
            <section className="h-[40vh] sm:h-[50vh] lg:h-[calc(100vh-7rem)] flex items-center justify-center bg-background border-b border-foreground/5">
    ...
    return (
        <section className="relative h-[40vh] sm:h-[50vh] lg:h-[calc(100vh-7rem)] w-full overflow-hidden bg-background">
