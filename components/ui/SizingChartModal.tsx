    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
            <div className="p-6 border-b border-foreground/12 flex items-center justify-between">
              <div>
            ...
            <div className="p-6 overflow-x-auto">
              ...
              <div className="mt-8 p-4 bg-muted/30 rounded-2xl border border-foreground/12">
            ...
            <div className="p-6 bg-muted/20 border-t border-foreground/12">
              <button 
                onClick={onClose}
